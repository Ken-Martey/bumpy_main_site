...
?>
    ...
    <div class="innerHeading bg_f1f1f1 innerHeading-border stripeM">
        <div class="container text-center">
            <h1 class="marginBottomNone">Share Registry</h1>
            ...
            <div class="stripe stripeM">
                ...
                <div class="alert alert-danger dv-notify-failed" style="display:none">For some reason we can't process your order :( Please try again</div>
                  <form class="row dv-add-oneto:orders:order_list">
                    ...
                    <?php $item_list = [];foreach($_SESSION['registry'] as $item_in_cart){ array_push($item_list, $item_in_cart);
                      }
                    ?>
                    <input type="hidden" id="item_list" name="item_list" value="<?=htmlspecialchars(json_encode($item_list, true))?>">
                    <div class="col-lg-6">
                        <label>Payees Name Here*</label>
                            <input type="text" class="form-control" placeholder="Please enter payees Full Name" name="payees_name">
                        <label>Payees Email Here*</label>
                            <input type="email" class="form-control" placeholder="Please enter payees Email" name="payees_email">
                        ...
                        <br>
                            ...
                            <div class="row">
                            <div class="col-lg-12">
                            <label>Your Town/City/Location</label>
                            ...
                            <div class="row">
                            <div class="col-lg-12">
                            <label>Your Special Land Mark</label>
                    ...
                    <div class="col-lg-6">
                        ...
                        <textarea class="form-control" type="hidden" name="order_note" rows="6"></textarea>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12">
                            <div class="cartTotle">
                                ...
                                <br>
                                <button  class="btn cart-btn bg_e85200 pull-right ">Send Invitation</button>
                                </form>
...
<script>
    function addXMLRequestCallback(callback){
        ...
        if(response.status_code == 1000) {
            ...
            localStorage.setItem('payment_link', response.message);
